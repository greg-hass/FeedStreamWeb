      ...
      <div className="bg-gradient-to-br from-indigo-50 to-purple-50 dark:from-indigo-950/30 dark:to-purple-900/30 rounded-xl border border-indigo-100 dark:border-indigo-800/50 p-5 sm:p-6 relative overflow-hidden">
        ...
        {briefing ? (
          <div className="prose prose-indigo dark:prose-invert max-w-none">
            <div 
              className="text-zinc-700 dark:text-zinc-300 text-base leading-relaxed [&_h3]:text-indigo-900 [&_h3]:dark:text-indigo-200 [&_h3]:mt-4 [&_h3]:mb-2 [&_ul]:pl-5 [&_li]:mb-1"
              dangerouslySetInnerHTML={{ __html: DOMPurify.sanitize(briefing) }}
            />
